...
do{
  pregunta1= Number(prompt("Ingrese un numero del 1 al 10"))
} while (Number.isNaN(pregunta1) || 10<pregunta1 || pregunta1<0)


do{
  pregunta2 = Number(prompt("Ingrese otro numero difernte del 1 al 10"))   
    } while (Number.isNaN(pregunta2) || 10<pregunta2 || pregunta2<0)


 do{
   pregunta3 = Number(prompt("Ingrese otro numero diferente del 1 al 10"))
